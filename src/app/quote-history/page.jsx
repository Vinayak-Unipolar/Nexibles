      ...
      for (let i = 0; i < retries; i++) {
        try {
          ...
          const response = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/api/leads/email?email=${encodeURIComponent(
              userEmail
            )}`,
            {
              method: "GET",
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 md:pt-0 pt-8">Request Quote History</h2>
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              You have not requested any quotes yet. Start by requesting a quote to see your
              history here.
            </p>
