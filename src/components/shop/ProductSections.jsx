    ...
    <div className="mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 h-[450px]">
        <div className="relative flex items-center justify-center text-white text-center overflow-hidden">
          <img src={ProductStock.src} alt="Stock Products" className="absolute inset-0 w-full h-full object-cover z-0" />
        ...
        <div className="relative flex items-center justify-center text-white text-center overflow-hidden">
          <img src={Customization.src} alt="Customization Tool" className="absolute inset-0 w-full h-full object-cover z-0" />
          <div className="z-10  p-4">
