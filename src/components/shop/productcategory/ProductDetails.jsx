...
const ProductDetails = ({ minimumQuantity,priceAfterCalculation,handleQuantityInputChange,selectedQuantity,debouncedIncrease,debouncedDecrease,productDetails,name, description, material,productPrice }) => {
  return (
    <div className="relative z-20">
      <div className="md:h-auto">
        ...
        <h3 className='text-gray-900 text-sm md:mt-2'>Material : {material}</h3>
        <p className="prose prose-custom-description text-sm md:mt-2 " dangerouslySetInnerHTML={{ __html: description }} />
      </div>
