    ...
    return (
        ...
        >
            ...
            <div className="items-center w-full md:flex">
                ...
                <motion.div
                    className="md:w-1/2 md:pl-1 flex gap-2"
                    variants={itemVariants}
                >
                    {(parseInt(selectedQuantity, 10) || 0) >= minimumQuantity ? (
                        <>
                            <motion.button
                                ...
                                className="flex items-center justify-center w-full h-10 gap-2 px-4 py-2 text-xs font-medium text-white transition-all duration-200 bg-[#103b60] rounded-md shadow-sm "
