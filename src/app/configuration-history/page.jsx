...
import Link from "next/link"; // Corrected import, removed NavLink
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <div className="bg-white p-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 md:pt-0 pt-8">Configuration History</h2>
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              You haven&apos;t created any configurations yet. Start by creating a
              configuration to see your history here.
            </p>
            <div className="bg-[#103b60] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#0d2d4a] transition-colors duration-200">
              <Link href="/configuration-tool">Create a Configuration</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="bg-[#103b60] text-white px-4 py-2 rounded-full text-sm font-medium">
            ...
            {configurations.length === 1 ? "Configuration" : "Configurations"}
          </div>
        </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-sm text-gray-900">
                        {config.skus
                          .map((sku) => `${sku.design_name} (${sku.quantity})`)
                          .join(", ")}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex-shrink-0 h-5 w-5 text-gray-400 mt-0.5">
                      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M12 8c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm0 0c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm0 6c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2z"
                        />
                      </svg>
                    </div>
                    <div className="min-w-0 flex-1">
