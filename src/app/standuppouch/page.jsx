...
const StandUpPouches = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      setError(null);
      try {
        const response = await fetch(`${APIURL}/api/product/get_list/stand-up-pouch`, {
          method: 'GET',
          headers: {
  ...
  const pointerPositions = [
    { top: '5%', left: '50%', label: features[0] },
    { top: '15%', left: '65%', label: features[1] },
    { top: '40%', left: '45%', label: features[2] },
    { top: '30%', left: '35%', label: features[3] },
    { top: '85%', left: '50%', label: features[4] },
