            ...
            >
              {isLogin ? (
                <>
                  ...
                  <form onSubmit={showResendVerification ? handleResendVerification : handleLogin} className="flex flex-col space-y-4">
                    ...
                    >
                      {showResendVerification ? "Resend Verification Email" : "Log in"}
                    </button>
