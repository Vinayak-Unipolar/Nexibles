...
const OrderPlaced = ({ productDetails, defaultAddress, transactionId }) => {
  ...
  // Check if the order contains "Nexibles Sample Kit"
  const isNexiblesSampleKit = productDetails.some(
    (product) => product.product_name === "Nexibles Sample Kit"
  );
          ...
          <div className="bg-white h-full w-full">
            <div className="md:p-10 p-4">
              ...
              <div className="mt-4">
                ...
                <hr />
                {/* Conditionally render GST section */}
                {!isNexiblesSampleKit && (
                  <>
                    <div className="flex justify-between items-center mb-2 mt-2">
                      <p className="text-gray-900 text-sm font-bold">GST (18%)</p>
                ...
                <div className="flex justify-between items-center py-2">
                  <p className="text-gray-900 text-sm font-bold">Shipping</p>
                  {productDetails[0]?.orderCharge && parseFloat(productDetails[0].orderCharge) > 0 ? (
                    <p className="text-gray-900 text-sm font-bold">
                      + RS. {parseFloat(productDetails[0].orderCharge).toFixed(2)}
                    </p>
              ...
              {productDetails.map((product, index) => (
                ...
                >
                  ...
                  <div className="flex-1 p-6">
                    ...
                    {!isNexiblesSampleKit && product.skuCount && (
                      <>
                        <div className="mb-3">
                          <p className="text-gray-800">
                            <span className="font-semibold">SKU Count:</span>{' '}
